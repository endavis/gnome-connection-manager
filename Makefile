...
install: translate
	...
	cp -r lang donate.gif gnome_connection_manager.py gnome-connection-manager.glade icon.png pyAES.py ssh.expect urlregex.py style.css $(DESTDIR)/usr/share/gnome-connection-manager/
