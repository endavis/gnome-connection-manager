...
from gnome_connection_manager.utils.SimpleGladeApp import SimpleGladeApp
from gnome_connection_manager.utils.SimpleGladeApp import bindtextdomain

import configparser
from gnome_connection_manager.utils import pyAES
...
def show_open_dialog(parent, title, action):
    ...
    dlg.add_button("document-save" if action==Gtk.FileChooserAction.SAVE else "document-open", Gtk.ResponseType.OK)
